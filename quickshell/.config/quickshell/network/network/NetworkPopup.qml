...
Item {
    ...
    function safeUiIcon(iconCandidate, fallbackIcon) {
        if (!iconCandidate || iconCandidate === "") return fallbackIcon;
        // Old cached glyphs from unsupported high PUA range may render blank.
        let cp = iconCandidate.codePointAt(0);
        if (cp > 0xFFFF) return fallbackIcon;
    ...
    Settings {
        ...
        location: "file://" + Quickshell.env("HOME") + "/.config/quickshell/network/qs_networkwidget.ini"
    ...
    readonly property string scriptsDir: Quickshell.env("HOME") + "/.config/quickshell/network/network"
        ...
        if (isActConn && cList.length > 0) {
            for (let i = 0; i < cList.length; i++) {
                ...
                if (window.activeMode === "wifi") {
                    ...
                    nodes.push({ id: "sig_" + i, name: sigValue, icon: obj.icon || "", action: "Signal Strength", isInfoNode: true, isActionable: false, parentIndex: cIndex });
                    nodes.push({ id: "sec_" + i, name: obj.security || "Open", icon: "", action: "Security", isInfoNode: true, isActionable: false, parentIndex: cIndex });
                    if (obj.ip) nodes.push({ id: "ip_" + i, name: obj.ip, icon: "", action: "IP Address", isInfoNode: true, isActionable: false, parentIndex: cIndex });
                    if (obj.freq) nodes.push({ id: "freq_" + i, name: obj.freq, icon: "", action: "Band", isInfoNode: true, isActionable: false, parentIndex: cIndex });
                } else {
                    nodes.push({ id: "bat_" + obj.mac, name: (obj.battery || "0") + "%", icon: "", action: "Battery", isInfoNode: true, isActionable: false, parentIndex: cIndex });
                    if (obj.profile) {
                        nodes.push({ id: "prof_" + obj.mac, name: obj.profile, icon: (obj.profile === "Hi-Fi (A2DP)" ? "" : ""), action: "Audio Profile", isInfoNode: true, isActionable: false, parentIndex: cIndex });
                    }
                    nodes.push({ id: "mac_" + obj.mac, name: obj.mac || "Unknown", icon: "", action: "MAC Address", isInfoNode: true, isActionable: false, parentIndex: cIndex });
                }
            }
            nodes.push({ id: "action_scan", name: "Scan Devices", icon: "", action: "Switch View", isInfoNode: true, isActionable: true, cmdStr: "TOGGLE_VIEW", parentIndex: -1 });
        }
    ...
    function processWifiJson(textData) {
        ...
        try {
            ...
            if (isNowWifiConn && window.activeMode === "wifi") {
                newNetworks.push({ id: "action_settings", ssid: "Current Device", mac: "", name: "Current Device", icon: "", security: "", action: "View Info", isInfoNode: false, isActionable: true, cmdStr: "TOGGLE_VIEW", parentIndex: -1 });
            }
    ...
    function processBtJson(textData) {
        ...
        try {
            ...
            if (isNowBtConn && window.activeMode === "bt") {
                newDevices.push({ id: "action_settings", ssid: "", mac: "action_settings", name: "Current Device", icon: "", action: "View Info", isInfoNode: false, isActionable: true, cmdStr: "TOGGLE_VIEW", parentIndex: -1 });
            }
                        ...
                        Rectangle {
                            ...
                            Item {
                                ...
                                ColumnLayout {
                                    ...
                                    Text { Layout.alignment: Qt.AlignHCenter; font.family: window.iconFontFamily; font.pixelSize: window.s(32); color: window.crust; text: "" }
                                    
                                    Text { 
                                        Layout.alignment: Qt.AlignHCenter; Layout.maximumWidth: pwdLayer.width - window.s(40)
                                        renderType: Text.NativeRendering
                                        font.family: window.uiFontFamily; font.weight: Font.Bold; font.pixelSize: window.s(13)
                                    ...
                                    Rectangle {
                                        ...
                                        TextInput {
                                            ...
                                            font.family: window.uiFontFamily; font.pixelSize: window.s(13); color: window.text
                            ...
                            Item {
                                ...
                                ColumnLayout {
                                    ...
                                    Text {
                                        ...
                                        text: isMyDisconnecting ? "" : (coreMa.containsMouse ? (window.activeMode === "wifi" ? "" : "") : (coreContainer.myDevice ? window.safeUiIcon(coreContainer.myDevice.icon, (window.activeMode === "wifi" ? "" : "")) : ""))
                                        Behavior on color { ColorAnimation { duration: 200 } }
                                    }
                                    ...
                                    Text {
                                        ...
                                        renderType: Text.NativeRendering
                                        font.family: window.uiFontFamily; font.weight: Font.Black
                                    ...
                                    Text {
                                        Layout.alignment: Qt.AlignHCenter
                                        font.family: window.uiFontFamily; font.weight: Font.Bold; font.pixelSize: window.s(11)
                            ...
                            Rectangle {
                                ...
                                Item {
                                    ...
                                    RowLayout {
                                        ...
                                        Text { font.family: window.iconFontFamily; font.pixelSize: window.s(20); color: window.crust; text: icon }
                                        ...
                                        ColumnLayout {
                                            ...
                                            Item {
                                                ...
                                                Text {
                                                    ...
                                                    renderType: Text.NativeRendering
                                                    text: floatCard.itemName
                                                    font.family: window.uiFontFamily; font.weight: Font.Bold; font.pixelSize: window.s(13); color: window.crust 
                                                }
                                                Text { 
                                            ...
                                            Text {
                                                font.family: window.uiFontFamily; font.pixelSize: window.s(10); color: window.crust
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            anchors.centerIn: parent
                            spacing: window.s(8)
                            Text { font.family: window.iconFontFamily; font.pixelSize: window.s(18); color: window.activeMode === "wifi" ? window.crust : window.text; text: ""; Behavior on color { ColorAnimation{duration:200} } }
                            Text { font.family: window.uiFontFamily; font.weight: Font.Black; font.pixelSize: window.s(13); color: window.activeMode === "wifi" ? window.crust : window.text; text: "Wi-Fi"; Behavior on color { ColorAnimation{duration:200} } }
                        }
                        MouseArea {
                    ...
                    Rectangle {
                        ...
                        RowLayout {
                            anchors.centerIn: parent
                            spacing: window.s(8)
                            Text { font.family: window.iconFontFamily; font.pixelSize: window.s(18); color: window.activeMode === "bt" ? window.crust : window.text; text: ""; Behavior on color { ColorAnimation{duration:200} } }
                            Text { font.family: window.uiFontFamily; font.weight: Font.Black; font.pixelSize: window.s(13); color: window.activeMode === "bt" ? window.crust : window.text; text: "Bluetooth"; Behavior on color { ColorAnimation{duration:200} } }
                        }
                        MouseArea {
